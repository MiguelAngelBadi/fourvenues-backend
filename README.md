...
Fourvenues api builded with [NestJS](https://github.com/nestjs/nest), [Swagger](https://swagger.io/) and [Docker](https://www.docker.com/).
...
- Api local swagger documentation: http://localhost:7000/api
